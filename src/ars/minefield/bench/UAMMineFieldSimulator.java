...
public class UAMMineFieldSimulator implements MatrixTraverseListener {
	// -------------------------------------------------------------------------------------------------------
	private int iterationCount;
	private int maxIterationCount;
	private MineField mineField;
	//private Agent agent;
	private UAM_Agent agent;
	...
	public void setAgent(UAM_Agent agent){
		this.agent = agent;
		agent.init(this);
	}
	// -------------------------------------------------------------------------------------------------------
	public UAMMineFieldSimulator(int maxIterationCountp, int w, int h, int mines) {
	...
	// -------------------------------------------------------------------------------------------------------
	public void simulateAll(boolean sleep, boolean freezeIteration, Integer[] iterations) {
		...
		// set the total iterations spent by this agent
		iterations[0] = iterationCount;
	}
	// -------------------------------------------------------------------------------------------------------
	@Override
